...
public class AdminController {
	...
	// 이미지 수정
	/*
	 * @RequestMapping(value="/admin/stdUpdate" , method=RequestMethod.POST) public
	 * String stdUpdate(MultipartHttpServletRequest req, RedirectAttributes red) {
	 * service.stdUpdate(req, red); return "redirect:/admin/stdMyPage"; }
	 */
	// 학생정보수정
