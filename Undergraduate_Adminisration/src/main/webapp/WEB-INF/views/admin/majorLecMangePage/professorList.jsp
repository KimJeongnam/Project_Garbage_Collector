		...
		<c:forEach var="pro" items="${dtos }">
			<tr>
				<td class="text-center" style="vertical-align: middle;"><img
					src="/project/resources${pro.userImage}"
					class="img-thumbnail img-responsive"
					style="height: 90px; width: 80px;" alt="..."></td>
				...
				<td class="text-center" style="vertical-align: middle;"><input
					class="btn btn-primary" type="button" value="선택"
				...
				<c:if test="${cnt > 0 }">
					...
					<c:if test="${pageCount > endPage }">
						<li class="paginate_button next" id="datatable_next"
							style="cursor: pointer;"
							onclick="professorList(${startPage + pageBlock });"><a
							aria-controls="datatable" tabindex="0">Next</a></li>
						<li class="paginate_button next" id="datatable_next"
							style="cursor: pointer;" onclick="professorList(${pageCount });">
...
function selectProfessor(empNumber, majorNum){
	...
	$(opener.document).find("#empNumber").val(empNumber);
