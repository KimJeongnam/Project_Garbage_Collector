...
UPDATE LECTURESELECTPERIOD SET
    STARTSELECTLECTURE = TO_DATE('2019-02-21 17:15', 'YYYY-MM-DD HH24:MI')
    , ENDSELECTLECTURE = TO_DATE('2019-02-21 17:20', 'YYYY-MM-DD HH24:MI')
    , OPENINGDAY = TO_DATE('2019-02-21 17:25', 'YYYY-MM-DD HH24:MI')
    , GARDEOPENINGDAY = TO_DATE('2019-02-21 17:30', 'YYYY-MM-DD HH24:MI')
    , ENDINGDAY = TO_DATE('2019-02-21 17:35', 'YYYY-MM-DD HH24:MI')
