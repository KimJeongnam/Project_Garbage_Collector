                        ...
                        <div class="menu_section active">
                         ...
                         <li><a><i class="fa fa-desktop"></i>개인정보<span class="fa fa-chevron-down"></span></a>
                            <ul class="nav child_menu" style="display: none;">
                                        <li><a href="personalProfile">학생개인정보<span class="fa fa-chevron-down"></span></a>
                                    </li>
                                    </ul>
                                </li>
                                <li class=""><a><i class="fa fa-graduation-cap"></i>학사관리<span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu" style="display: none;">
                                        ...
                                        <li class="sub_menu">
                                        <a href="lectureList">수강신청</a></li>
                                        <li><a href="schoolTimeTable">시간표 조회/수정</a></li>
                                         </ul>
                                    </li>
                                ...
                                <li><a><i class="fa fa-users"></i> 학적<span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu" style="">
                                        <li><a href="menu4">휴학신청</a></li>
                                        <li><a href="menu7">복학신청</a></li>
                                    </ul>
                                </li>
                                <li><a><i class="fa fa-desktop"></i> 장학관리 <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu" style="">
                                        <li><a href="bulletin">장학금 신청</a></li>
                                        <li><a href="management">장학금 수혜내역</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
